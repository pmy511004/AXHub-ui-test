...
export default function AppDetailView({ appName, category, onBack, fromMenu, isAdmin, appStatus }: AppDetailViewProps) {
  const primaryColor = isAdmin ? "#2D64FA" : "#2D64FA";
    ...
    <div className="mx-auto flex w-full flex-col gap-6 pb-[100px] min-[1281px]:max-w-[1280px]" style={{ animation: "fadeSlideIn 0.4s ease-out" }}>
      ...
      {isAdmin && !guideHidden && (() => {
        ...
        const chipClass = (state: string) =>
          state === "done" || state === "active" ? "bg-[#2D64FA]" : "relative overflow-hidden bg-[#2D64FA]";
        const chipOverlay = (state: string) =>
          state === "future";
        const labelClass = (state: string) =>
          state === "active" ? "font-semibold text-[#2D64FA]"
              ...
              <div className="flex items-center gap-2">
                <div className="flex flex-1 items-center gap-1">
                  <button type="button" onClick={() => setGuideDismissed(!guideDismissed)} className="flex size-6 items-center justify-center p-[3px]">
                    {guideDismissed ? (
                      <span className="flex size-full items-center justify-center rounded border-[1.5px] border-[#2D64FA] bg-[#2D64FA]">
            ...
            <div className="flex h-[177px] flex-col gap-6 rounded-2xl bg-surface p-6">
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-1">
                  ...
                  {guideComplete ? (
                    <span className="shrink-0 text-sm font-semibold leading-[1.5] tracking-[-0.14px] text-[#2D64FA]">스토어에서 보기</span>
              ...
              <div className="relative flex items-start justify-between">
                ...
                <div className="absolute left-[26px] top-[9px] h-1.5 overflow-hidden rounded-full bg-[#2D64FA] transition-all duration-500" style={{ width: fillWidth }}>
                ...
                {steps.map((step) => (
                  <button key={step.num} type="button" onClick={() => { setGuideComplete(false); setActiveTab(step.tab); }} className="group relative z-10 flex w-[65px] flex-col items-center gap-3 transition hover:scale-110">
                    ...
                    <span className={`whitespace-nowrap text-xs leading-[1.3] tracking-[-0.12px] ${labelClass(step.state)} transition group-hover:text-[#2D64FA]`}>{step.label}</span>
                  </button>
                ))}
                {/* 앱 공개 */}
                <button type="button" onClick={() => setGuideComplete(true)} className="group relative z-10 flex flex-col items-center transition hover:scale-110">
                  <span
                    className={`flex items-center justify-center rounded-full px-2 py-1 text-xs font-semibold leading-[1.3] tracking-[-0.12px] text-white transition ${appPublished ? "bg-[#2D64FA]" : "relative overflow-hidden bg-[#2D64FA] group-hover:brightness-90"}`}
      ...
      <div className="flex items-center gap-4 py-5">
        ...
        <div className="flex flex-1 flex-col justify-between self-stretch">
          ...
          <div className="flex items-start gap-2">
            {isAdmin ? (
              <span className="relative flex h-8 items-center justify-center overflow-hidden rounded-xl bg-[#2D64FA] px-4 text-sm font-semibold leading-[1.5] tracking-[-0.14px] text-white">
                배포 전
              ...
              <button
                type="button"
                className="flex h-8 items-center justify-center overflow-hidden rounded-xl px-4 text-xs font-semibold leading-[1.3] tracking-[-0.12px] text-[#2D64FA] bg-[rgba(251,176,59,0.1)] hover:bg-[rgba(251,176,59,0.2)] transition-colors"
              >
                받기
              </button>
            )}
      ...
      {activeTab === "앱" ? (
          ...
          <div className="flex flex-col gap-5 border-b border-[rgba(82,82,91,0.08)] py-10">
            ...
            <div className="flex items-end justify-between">
              ...
              <button
                ...
                className="shrink-0 px-2 text-sm font-semibold leading-[1.5] tracking-[-0.14px] text-[#2D64FA]"
              >
                {expanded ? "접기" : "더보기"}
              </button>
            </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          {namingModalOpen && (
            <div className="fixed inset-0 z-30 flex items-center justify-center bg-black/20" onClick={() => setNamingModalOpen(false)}>
              ...
              >
                ...
                <button type="button" onClick={() => setNamingModalOpen(false)} className="flex h-9 items-center justify-center rounded-lg bg-[#2D64FA] px-8 py-2 text-sm font-semibold leading-[1.5] tracking-[-0.14px] text-white transition-opacity hover:opacity-90">
                  확인
                </button>
              </div>
            </div>
          ...
          {gitStep === "login" ? (
            ...
            <div className="flex flex-col items-center gap-6 py-10">
              ...
              <button type="button" onClick={() => setGitStep("install")} className="flex h-9 items-center justify-center rounded-lg bg-[#2D64FA] px-4 py-2 text-sm font-bold leading-[1.5] tracking-[-0.14px] text-white transition-opacity hover:opacity-90">
                GitHub 로그인
              </button>
            </div>
          ) : gitStep === "install" ? (
            ...
            <div className="flex flex-col items-center gap-6 py-10">
              ...
              <div className="flex items-start gap-2">
                ...
                <button type="button" onClick={() => setGitStep("repo")} className="flex h-9 items-center justify-center rounded-lg bg-[#2D64FA] px-4 py-2 text-sm font-bold leading-[1.5] tracking-[-0.14px] text-white transition-opacity hover:opacity-90">
                  이 계정에 앱 설치
                </button>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-6 py-5">
              ...
              <div className="flex flex-col gap-2">
                {["minion/AXHub-test", "minion/AXHub-test2", "minion/AXHub-test3"].map((repo) => (
                  <button key={repo} type="button" onClick={() => setSelectedRepo(selectedRepo === repo ? null : repo)} className={`flex flex-col items-start gap-2 rounded-xl border p-4 text-left transition-colors ${selectedRepo === repo ? "border-[#2D64FA] bg-[#fdf2f8]" : "border-[#e4e4e7] bg-white hover:border-[#d4d4d8]"}`}>
              ...
              <div className="flex flex-col gap-3">
                ...
                <input
                  ...
                  className="min-h-[48px] rounded-xl border border-[#e4e4e7] bg-white px-4 text-base font-normal leading-[1.5] tracking-[-0.16px] text-[#18181b] placeholder:text-[#a1a1aa] focus:border-[#2D64FA] focus:outline-none"
                />
              </div>
              <button
                type="button"
                ...
                className="relative flex h-9 w-fit items-center justify-center overflow-hidden rounded-lg bg-[#2D64FA] px-4 py-2 text-sm font-semibold leading-[1.5] tracking-[-0.14px] text-white transition-opacity hover:opacity-90"
              >
                저장소 연결
            ...
            <div className="flex flex-col items-center gap-6 py-10">
              ...
              <div className="flex w-[350px] flex-col items-center gap-2 overflow-hidden rounded-xl bg-[#f4f4f5] p-5">
                <p className="text-lg font-semibold leading-[1.4] tracking-[-0.18px] text-[#2D64FA]">{selectedRepo}</p>
        ...
        <div className="flex flex-col gap-6">
          ...
          {envModalOpen && (
            <div className="fixed inset-0 z-30 flex items-center justify-center bg-black/20" onClick={() => setEnvModalOpen(false)}>
              ...
              >
                ...
                <button type="button" onClick={() => setEnvModalOpen(false)} className="flex h-9 items-center justify-center rounded-lg bg-[#2D64FA] px-8 py-2 text-sm font-semibold leading-[1.5] tracking-[-0.14px] text-white transition-opacity hover:opacity-90">
                  확인
                </button>
              </div>
            </div>
          ...
          <div className="flex flex-col items-center gap-6 py-10">
            ...
            <button type="button" onClick={() => { setEnvKey(""); setEnvValue(""); setEnvType(null); setEnvAddModalOpen(true); }} className="flex h-9 items-center justify-center rounded-lg bg-[#2D64FA] px-4 py-2 text-sm font-bold leading-[1.5] tracking-[-0.14px] text-white transition-opacity hover:opacity-90">
              환경변수 추가
            </button>
          </div>
          ) : (
            ...
            <div className="fixed inset-0 z-30 flex items-center justify-center bg-black/20" onClick={() => setEnvAddModalOpen(false)}>
              ...
              >
                ...
                <div className="flex w-full flex-col gap-3">
                  ...
                  <div className="flex flex-col gap-2">
                    <input type="text" value={envKey} onChange={(e) => setEnvKey(e.target.value)} placeholder="DB_URL..." className="min-h-[48px] rounded-xl border border-[#e4e4e7] bg-white px-4 text-base font-normal leading-[1.5] tracking-[-0.16px] text-[#18181b] placeholder:text-[#a1a1aa] focus:border-[#2D64FA] focus:outline-none" />
                ...
                <div className="flex w-full flex-col gap-3">
                  ...
                  <div className="flex flex-col gap-2">
                    <input type="text" value={envValue} onChange={(e) => setEnvValue(e.target.value)} placeholder="********" className="min-h-[48px] rounded-xl border border-[#e4e4e7] bg-white px-4 text-base font-normal leading-[1.5] tracking-[-0.16px] text-[#18181b] placeholder:text-[#a1a1aa] focus:border-[#2D64FA] focus:outline-none" />
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex gap-2">
                      {[
                        ...
                        <button key={env.key} type="button" onClick={() => setEnvType(envType === env.key ? null : env.key)} className={`flex flex-1 flex-col gap-2 rounded-xl border p-4 text-left transition-colors ${envType === env.key ? "border-[#2D64FA] bg-[#fdf2f8]" : "border-[#e4e4e7] bg-white hover:border-[#d4d4d8]"}`}>
              ...
              >
                ...
                <div className="flex items-start gap-2">
                  ...
                  <button
                    ...
                    className="flex h-9 items-center justify-center rounded-lg bg-[#2D64FA] px-8 py-2 text-sm font-semibold leading-[1.5] tracking-[-0.14px] text-white transition-opacity hover:opacity-90"
                  >
                    삭제
                  </button>
                </div>
            ...
            <>
              ...
              <div className="flex flex-col gap-6 py-5">
                <div className="flex items-center gap-6">
                  ...
                  <button type="button" onClick={() => {}} className="flex h-9 items-center justify-center rounded-lg bg-[#2D64FA] px-4 py-2 text-sm font-bold leading-[1.5] tracking-[-0.14px] text-white transition-opacity hover:opacity-90">수동 배포</button>
                </div>
                {/* 배포 정보 카드 */}
              ...
              <div className="flex flex-col items-center gap-6 py-5">
                <div className="flex w-full items-end gap-6">
                  <div className="flex flex-1 items-start gap-2">
                    ...
                    <span className="text-lg font-semibold leading-[1.4] tracking-[-0.18px] text-[#2D64FA]">10건</span>
                  </div>
                  <div className="relative">
                    ...
                    {deployFilterOpen && (
                      <div className="absolute right-0 top-full z-20 mt-1 flex min-w-[140px] flex-col overflow-hidden rounded-xl bg-white shadow-[0px_4px_16px_rgba(0,0,0,0.12)]">
                        {["전체 상태", "Pending", "Building", "Running", "Failed", "Stopped"].map((f) => (
                          <button key={f} type="button" onClick={() => { setDeployFilter(f); setDeployFilterOpen(false); }} className={`flex items-center gap-2 px-4 py-2.5 text-left text-sm leading-[1.5] tracking-[-0.14px] transition-colors hover:bg-gray-50 ${deployFilter === f ? "font-semibold text-[#2D64FA]" : "font-normal text-[#3f3f46]"}`}>
              ...
              <div className="flex flex-col gap-6 py-5">
                <div className="flex items-start gap-2">
                  ...
                  <span className="text-lg font-semibold leading-[1.4] tracking-[-0.18px] text-[#2D64FA]">0건</span>
                </div>
                {/* 통계 카드 3열 */}
                  ...
                  {ciFilterOpen && (
                    <div className="absolute right-0 top-full z-20 mt-1 flex min-w-[140px] flex-col overflow-hidden rounded-xl bg-white shadow-[0px_4px_16px_rgba(0,0,0,0.12)]">
                      {["전체 활동", "자동 배포", "수동 배포"].map((f) => (
                        <button key={f} type="button" onClick={() => { setCiFilter(f); setCiFilterOpen(false); }} className={`px-4 py-2.5 text-left text-sm leading-[1.5] tracking-[-0.14px] transition-colors hover:bg-gray-50 ${ciFilter === f ? "font-semibold text-[#2D64FA]" : "font-normal text-[#3f3f46]"}`}>
                          {f}
                        </button>
                      ))}
                    </div>
          ...
          <div className="flex flex-col items-center gap-6 py-10">
            {gitStep === "connected" ? (
              <>
                ...
                <button type="button" onClick={() => setDeployStarted(true)} className="flex h-9 items-center justify-center rounded-lg bg-[#2D64FA] px-4 py-2 text-sm font-bold leading-[1.5] tracking-[-0.14px] text-white transition-opacity hover:opacity-90">
                  수동 배포
                </button>
              </>
            ) : (
              <>
                ...
                <button type="button" onClick={() => setActiveTab("Git 연동")} className="flex h-9 items-center justify-center rounded-lg bg-[#2D64FA] px-4 py-2 text-sm font-bold leading-[1.5] tracking-[-0.14px] text-white transition-opacity hover:opacity-90">
                  Git 연동
                </button>
              </>
            )}
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center justify-center gap-6 py-10">
            ...
            <button type="button" onClick={() => { setMemberAddModalOpen(true); setMemberAddMode("user"); setSelectedMemberUser(null); setSelectedMemberRole(null); setMemberDropdownOpen(false); setMemberPermission("구성원 (보기 권한)"); setMemberPermDropdownOpen(false); }} className="flex h-9 items-center justify-center rounded-lg bg-[#2D64FA] px-4 py-2 text-sm font-bold leading-[1.5] tracking-[-0.14px] text-white transition-opacity hover:opacity-90">
              멤버 추가
            </button>
          </div>
          ) : (
                ...
                >
                  ...
                  <div className="flex w-full flex-col gap-3">
                    ...
                    <div className="flex w-full gap-3">
                      <button type="button" onClick={() => { setMemberAddMode("user"); setSelectedMemberUser(null); setSelectedMemberRole(null); setMemberDropdownOpen(false); }} className={`flex flex-1 flex-col gap-2 rounded-xl border p-4 text-left transition-colors ${isUserMode ? "border-[#2D64FA] bg-[#fdf2f8]" : "border-[#e4e4e7] bg-white hover:border-[#d4d4d8]"}`}>
                      ...
                      <button type="button" onClick={() => { setMemberAddMode("role"); setSelectedMemberUser(null); setSelectedMemberRole(null); setMemberDropdownOpen(false); }} className={`flex flex-1 flex-col gap-2 rounded-xl border p-4 text-left transition-colors ${!isUserMode ? "border-[#2D64FA] bg-[#fdf2f8]" : "border-[#e4e4e7] bg-white hover:border-[#d4d4d8]"}`}>
                      ...
                      {memberPermDropdownOpen && (
                        <div className="absolute left-0 right-0 top-[calc(100%+4px)] z-10 rounded-xl border border-[#e4e4e7] bg-white py-1 shadow-lg">
                          {["구성원 (보기 권한)", "구성원 (편집 권한)", "관리자"].map((perm) => (
                            <button key={perm} type="button" onClick={() => { setMemberPermission(perm); setMemberPermDropdownOpen(false); }} className={`flex w-full px-4 py-2.5 text-left text-sm leading-[1.5] tracking-[-0.14px] transition-colors hover:bg-gray-50 ${memberPermission === perm ? "font-semibold text-[#2D64FA]" : "font-normal text-[#18181b]"}`}>
                              {perm}
                            </button>
                          ))}
                        </div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <button
                      ...
                      disabled={!isSelected}
                      onClick={handleAdd}
                      className="relative flex h-9 items-center justify-center overflow-hidden rounded-lg bg-[#2D64FA] px-8 py-2 text-sm font-semibold leading-[1.5] tracking-[-0.14px] text-white transition-opacity hover:opacity-90"
                    >
                      추가
